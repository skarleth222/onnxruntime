...
valgrind --leak-check=full --show-leak-kinds=definite --max-threads=3000 --num-callers=30 --keep-debuginfo=yes --log-file=valgrind.log ${ORT_SOURCE}/build/Linux/Release/onnxruntime_perf_test -e tensorrt -r 1 ${ONNX_MODEL}
